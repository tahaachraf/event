...
function createPool(config) {
    return new ConnectionPool(mariadb.createPool({
        dateStrings: true,
        ...config,
    }));
}

export { ConnectionPool, DuplicateKey, createPool, _escapeIdLoose as escapeIdLoose, _escapeIdStrict as escapeIdStrict, _escapeValue as escapeValue, sql };
